...
Dashboard page components (Projects, Agents, Usage, Billing) SHALL NOT display page headers with titles and action buttons at the top. Action buttons SHALL be positioned at the bottom of the page content.
